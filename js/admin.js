  ...
  async function loadDashboardStats() {
    try {
      ...
      if (stats.lowCementStockCount > 0) {
        ...
        alertDiv.innerHTML = `⚠️ <strong>Low Cement Stock Alert:</strong> ${stats.lowCementStockCount} cement product(s) are below minimum stock level. <a href="materials.html" style="color:var(--danger-color);text-decoration:underline;">View Materials →</a>`;
      } else {
